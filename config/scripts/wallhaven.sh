...
URL="https://wallhaven.cc/api/v1/search?q=minimalism,colorful&categories=100&purity=100&atleast=3840x2160&ratios=16x9&sorting=random"
ID="$(curl --silent "$URL" | jq -r '.data[8].id')"
